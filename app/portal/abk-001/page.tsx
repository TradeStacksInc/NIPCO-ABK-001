...
export default function ABK001Portal() {
                        ...
                        <>
                          <div className="flex items-center gap-3">
                            ...
                            <Input
                              ...
                              className="text-xl font-semibold bg-gray-800/50 border-gray-700/50 text-gray-300"
                            />
                          </div>
                          <div className="flex items-center gap-3">
                            ...
                            <Input
                              ...
                              className="text-base bg-gray-800/50 border-gray-700/50 text-gray-300"
                            />
                          </div>
                          <div className="flex items-center gap-3">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <h3 className="text-lg font-semibold text-gray-300 flex items-center gap-2">
                        <span className="text-sm bg-gray-800/50 px-2 py-1 rounded-md border border-gray-700/50">
                          NGN
                        </span>
                        Current Expected Revenue
                      </h3>
                      <div className="text-right">
                        <p className="text-2xl font-bold text-gray-300">NGN {expectedRevenue.toLocaleString()}</p>
                        <p className="text-sm text-gray-400">Full Capacity</p>
                      </div>
                    </div>

                    <div className="pipe-gauge h-12 rounded-2xl relative overflow-hidden">
                      <div
                        className="pipe-fill h-full rounded-2xl transition-all duration-1000 ease-out bg-gradient-to-r from-blue-400 to-blue-500"
                    ...
                    <div className="grid grid-cols-3 gap-4 text-sm">
                      <div className="text-center">
                        ...
                        <p className="text-blue-400 font-semibold text-base">NGN {currentRevenue.toLocaleString()}</p>
                      </div>
                      <div className="text-center">
                        <p className="text-gray-400">Progress</p>
                        <p className="text-gray-400 font-semibold text-base">{revenuePercentage.toFixed(1)}%</p>
                      </div>
                      <div className="text-center">
                        <p className="text-gray-400">Tanks</p>
                        <p className="text-blue-400 font-semibold text-base">4 Total</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="grid gap-8 grid-cols-2">
              <Card className="glass-card glass-card-hover rounded-3xl border-gray-700/50">
                ...
                <CardContent className="p-6 space-y-4">
                  <div className="alert-modern alert-warning rounded-2xl">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <div className="w-3 h-3 bg-orange-500 rounded-full animate-pulse"></div>
                        <span className="text-orange-300 font-medium text-base">All Tanks Empty</span>
                      </div>
                  ...
                  <div className="alert-modern alert-success rounded-2xl">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <Shield className="w-5 h-5 text-green-400" />
                        <span className="text-green-300 font-medium text-base">System Ready</span>
                      </div>
              ...
              <Card className="glass-card glass-card-hover rounded-3xl border-gray-700/50">
                <CardHeader className="pb-6">
                  <div className="flex-row items-center justify-between">
                    <CardTitle className="text-xl flex items-center gap-3 text-blue-400">
                      <div className="p-2 bg-blue-400/10 rounded-xl">
                        <span className="text-sm bg-blue-400/20 px-2 py-1 rounded-md border border-blue-400/30 text-blue-400">
                          NGN
                        </span>
                      </div>
                      Revenue Overview
                ...
                <CardContent className="p-6">
                  <div className="space-y-6">
                    <div className="flex justify-between items-center p-4 bg-gradient-to-r from-gray-400/5 to-gray-400/10 rounded-2xl border border-gray-400/20">
                      <span className="text-gray-300 font-medium text-base">Today's Revenue</span>
                      <span className="font-bold text-3xl text-gray-300">
                        NGN {realtimeRevenue.today.toLocaleString()}
                      </span>
                    </div>
                    <div className="grid grid-cols-2 gap-4">
                      <div className="p-4 bg-gradient-to-br from-blue-400/5 to-blue-400/10 rounded-2xl border border-blue-400/20">
                        <span className="text-gray-300 text-sm">Morning Shift</span>
                        <p className="font-bold text-lg text-blue-400">
                          NGN {realtimeRevenue.morning.toLocaleString()}
                        </p>
                      </div>
                      <div className="p-4 bg-gradient-to-br from-blue-400/5 to-blue-400/10 rounded-2xl border border-blue-400/20">
                        <span className="text-gray-300 text-sm">Afternoon Shift</span>
                        <p className="font-bold text-lg text-blue-400">
            ...
            <Card className="glass-card glass-card-hover rounded-3xl border-gray-700/50">
              <CardHeader className="pb-6">
                <div className="flex flex-col gap-4">
                  <div className="flex items-center justify-between">
                    <CardTitle className="text-xl flex items-center gap-3 text-gray-400">
                      <div className="p-2 bg-gray-400/10 rounded-xl">
                    ...
                    <div className="flex gap-3">
                      <Button
                        ...
                        className="bg-blue-500 text-black border-blue-500 hover:bg-blue-600 hover:border-blue-600 rounded-xl font-semibold"
                      >
                        <Calculator className="h-4 w-4 mr-2 text-black" />
                        Total Sales
                      </Button>
                      <Button
                        className="bg-gray-400 text-black hover:bg-gray-500 rounded-xl font-semibold"
                  ...
                  <div className="flex-row flex-wrap gap-4">
                    ...
                    >
                      <SelectTrigger className="glass-card border-gray-700/50 text-gray-300 rounded-xl w-40">
                    ...
                    {(dateFilter || shiftFilter) && (
                      <Button
                        ...
                        className="text-gray-400 hover:text-white hover:bg-gray-400/10 rounded-xl"
                      >
                        Clear Filters
                      </Button>
                    )}
              ...
              <CardContent className="p-6">
                {paginatedSalesHistory.length > 0 ? (
                    ...
                    <Table>
                      <TableHeader>
                        <TableRow className="border-gray-700/50">
                          <TableHead className="text-gray-400 font-semibold text-sm">Staff</TableHead>
                          <TableHead className="text-gray-400 font-semibold text-sm">Tank</TableHead>
                          <TableHead className="text-gray-400 font-semibold text-sm">Dispenser</TableHead>
                          <TableHead className="text-gray-400 font-semibold text-sm">Nozzle</TableHead>
                          <TableHead className="text-gray-400 font-semibold text-sm">Amount</TableHead>
                          <TableHead className="text-gray-400 font-semibold text-sm">Shift</TableHead>
                          <TableHead className="text-gray-400 font-semibold text-sm">Status</TableHead>
                        </TableRow>
                      </TableHeader>
                      <TableBody>
                        {paginatedSalesHistory.map((sale) => (
                          <TableRow key={sale.id} className="table-row-modern">
                            <TableCell className="text-gray-300 font-medium text-sm">{sale.attendant}</TableCell>
                            <TableCell className="text-gray-300 text-sm">{sale.tank}</TableCell>
                            <TableCell className="text-gray-300 text-sm">{sale.dispenser}</TableCell>
                            <TableCell className="text-gray-300 text-sm">{sale.nozzle}</TableCell>
                            <TableCell className="text-gray-300 font-semibold text-sm">
                  ...
                  <div className="flex items-center justify-center h-48 text-gray-400">
                    <div className="text-center">
                      <div className="p-4 bg-gray-400/5 rounded-2xl inline-block mb-4">
                ...
                {totalPages > 1 && (
                  <div className="flex-row items-center justify-between mt-6 pt-6 border-t border-gray-700/50">
                    ...
                    <div className="flex items-center gap-2">
                      <Button
                        ...
                        className="text-gray-400 hover:text-white disabled:opacity-50 rounded-xl"
                      >
                        ...
                        {Array.from({ length: Math.min(totalPages, 5) }, (_, i) => {
                          ...
                          return page <= totalPages ? (
                            <Button
                              ...
                              className={
                                currentPage === page
                                  ? "bg-gradient-to-r from-blue-400 to-blue-500 text-black hover:from-blue-500 hover:to-blue-600 rounded-xl"
        ...
        <header className="header-modern flex shrink-0 items-center gap-2 px-6 h-20">
          ...
          <div className="flex flex-1 items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-blue-400">{stationConfig.name}</h1>
            ...
            <div className="flex items-center gap-4">
              <Button
                ...
                className="text-gray-400 hover:text-blue-400 hover:bg-blue-400/10 relative rounded-xl transition-all duration-300 animate-pulse-glow"
              >
